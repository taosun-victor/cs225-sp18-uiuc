...
/*
TEST_CASE("print out DFS iterator visits", "[weight=1][part=1]") {
  PNG png = getTestPNG();
  Point startPoint(0, 0);
  
  DFS t(png, startPoint, 0.2);
  for (ImageTraversal::Iterator it = t.begin(); it != t.end(); ++it){
    cout << (*it).x << " " << (*it).y << " " << it.get_traversal()->empty() << endl;
  }
  cout << endl << endl;
}
...
TEST_CASE("DFS iterator visits always print out", "[weight=1][part=1]") {
  PNG png = getTestPNG();
  Point startPoint(0, 0);
  ...
  cout << (*it).x << " " << (*it).y << " " << it.get_traversal()->empty() << endl; ++it;
  cout << (*it).x << " " << (*it).y << " " << it.get_traversal()->empty() << endl; ++it;
  cout << (*it).x << " " << (*it).y << " " << it.get_traversal()->empty() << endl; ++it;
  cout << (*it).x << " " << (*it).y << " " << it.get_traversal()->empty() << endl; ++it;
  cout << (*it).x << " " << (*it).y << " " << it.get_traversal()->empty() << endl; ++it;
...
/* 
TEST_CASE("print out BFS iterator visits", "[weight=1][part=1]") {
  PNG png = getTestPNG();
  Point startPoint(0, 0);
