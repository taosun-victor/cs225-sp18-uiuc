...
/*
TEST_CASE("List::split_debug", "[weight=1][part=2]") { 
  List<int> list1;
  unsigned int length = 9;
  int array1[] = {4, 5, 7, 12, 17, 23, 32, 11, 13};
  for (unsigned i = 0; i < length; i++) { list1.insertBack(array1[i]); }
  list1.printList();
  cout << endl;

  List<int> list2 = list1.split(length/2);
  list1.printList();
  cout << endl;
  list2.printList();
  cout << endl;
...
/*
TEST_CASE("List::merge_debug", "[weight=1][part=2]") { 
  List<int> list1;
  int array1[6] = {4, 5, 7, 17, 111, 133};
  for (unsigned i = 0; i < 6; i++) { list1.insertBack(array1[i]); }
  list1.printList();
  cout << endl;

  List<int> list2;
  int array2[1] = {1};
  for (unsigned i = 0; i < 1; i++) { list2.insertBack(array2[i]); }
  list2.printList();
  cout << endl;
